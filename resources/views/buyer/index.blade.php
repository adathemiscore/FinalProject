  ...
  <main>
    @php
      $product = DB::table('products')
        ->select('products.id', 'products.seller_id','products.name', 'products.description', 'products.price', 'products.picture')
...
<div class="row row-cols-1 row-cols-md-5 mb-3 text-center">
      ...
      <div class="col">
        <div class="card mb-2 rounded-3 shadow-sm">
          ...
          <div class="card-body">
            <img src="{{asset("products/".$products->picture)}}" width="100" height="100"/>
            <ul class="list-unstyled mt-3 mb-4">
              <li>{{$products->name}}</li>
              <li>{{$products->description}}</li>
              <li style="color: green"><strong>${{number_format($products->price, 2, '.', '')}}</strong></li>
            </ul>
            <a class="w-100 btn btn-success" href="{{route('addtocart', [Sentinel::getUser()->id, $products->seller_id, $products->id])}}">
              Add to Cart 
