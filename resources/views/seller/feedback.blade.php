          ...
          @endif
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('feedbacksellerstore')}}">
                        @csrf
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-md-6">
                              {{-- <input id="message" type="text" class="form-control @error('message') is-invalid @enderror" name="message" value="{{ old('message') }}"  required> --}}
                                <textarea name="message" id="message" cols="20" class="form-control @error('message') is-invalid @enderror" rows="5" >{{ old('message')}}</textarea>
                              @error('message')
                                  <span class="invalid-feedback" role="alert">
                                      <strong>{{ $message }}</strong>
                                  </span>
